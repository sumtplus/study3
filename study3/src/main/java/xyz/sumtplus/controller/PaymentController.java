...
public class PaymentController {
	...
	/**
	 *	결제페이지로 넘어갈때 등록정보와, fno2를 파라미터로 받아서 feeVO를 모델에 부여함
	 *	결제전 임시등록
	 */
	@PostMapping("payment")
	...
	/**
	 *	결제완료페이지로 넘어갈때 결제정보와 등록정보를 파라미터로 받아서 regNo를 모델에 부여함
	 *	결제처리
	 */
	...
	/**
	 * 연장결제페이지로 데이터(post)보낼때 결제정보와 등록정보를 파라미터로 받음
	 * 결제처리
	 */
