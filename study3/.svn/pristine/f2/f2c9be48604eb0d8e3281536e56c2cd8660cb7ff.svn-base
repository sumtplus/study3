...
public class AdminServiceImpl implements AdminService{
	...
	@Override
	public AddressVO memberAddr(int userNo) {
		// TODO Auto-generated method stub
		log.warn("회원의 주소");
		return mapper.memberAddr(userNo);
	}
	...
	public void updateMember(MemberVO memberVO) {
		...
		log.warn(memberVO.getAddress());
		mapper.deleteAddr(memberVO);
		mapper.updateAddr(memberVO.getAddress());
	}
	...
	public List<Map<String, Object>> showLockerPlanInfo() {
		log.warn(mapper.getLockerPlanList());
		return mapper.getLockerPlanList();
	}
	...
	public void revokeLocker(Long userNo) {
		log.warn(mapper.deleteLocInfo(userNo));
		lockerMapper.delInfoupdateLocker(userNo);
	}
