...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "ovNzzmwlCfMn_oKfPYvB";
	private final static String CLIENT_SECRET = "7a148xeFmc";
	private final static String REDIRECT_URI = "https://zaksal.sumtplus.xyz/member/naverResult";
