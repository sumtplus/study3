...
<jsp:include page="../includes/adminHeader.jsp" />
                ...
                <div class="row">
                    <div class="col-7 align-self-center">
                        ...
                        <div class="d-flex align-items-center">
                        	<nav class="breadcrumb pl-0 mb-0">
	                            ...
	                            <span class="breadcrumb-item">등록정보관리</span>
	                            <span class="breadcrumb-item active">등록정보</span>
                            </nav>
                        </div>
                    </div>
                    <div class="col-5 align-self-center">
                        <div class="customize-input container-fluid">
                        	...
                        	<h6>기간별 조회</h6>
		                    <input class="col-5" type="text" name="daterange" id="daterange" />
		                    </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="pull-right">
	                               		<form id="actionForm" class="d-flex justify-content-center" action="regProperties${pageMaker.cri.listLink3}&pageNum=${num}" method='get'>
	                               			<ul class="pagination">
	                               				<c:if test="${pageMaker.prev}">
	                               					<li class="paginate_button previous"><a  class="page-link" href="${pageMaker.startPage - 1}">Prev</a></li>
	                               				</c:if>
	                               				<c:forEach var="num" begin="${pageMaker.startPage}" end="${pageMaker.endPage}">
	                               					<li class="page-item ${num == pageMaker.cri.pageNum ? 'active' : ''}"><a  class="page-link" href="regProperties${pageMaker.cri.listLink4}&pageNum=${num}">${num}</a></li>                              				
	                               				</c:forEach>
	...
	$("#search_button").click(function(){
    	...
    	if($(searchMenu).val() == ''){    		
    		...
    		alert("검색어를 입력해주세요");
    	}else if($(searchMenu).val() == 'R' && isNaN($(search).val())){
    		alert("등록번호를 입력해주세요");	
    	}else{
 			$("#searchForm").submit();   	
    	}
